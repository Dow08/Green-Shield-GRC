...
Et :
La société Vernier Composites SAS, représentée par son DSI/Représentant légal.

Objet : Encadrement des échanges d'informations hautement confidentielles dans le cadre de la mission d'accompagnement, d'audit de sécurité et de GRC de Vernier Composites SAS.
